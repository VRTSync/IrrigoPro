...
Parts Catalog Access: Billing managers now have complete access to the parts catalog with the same functionality as company administrators. This includes viewing all parts with pricing information, creating and editing parts, bulk import capabilities, advanced filtering and search, and QuickBooks integration for parts sync. The parts catalog is accessible via the navigation menu and provides full inventory management capabilities for billing personnel.
