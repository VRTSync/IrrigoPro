...
- **Navigation Spacing Fix (2025-07-23)**: Resolved persistent unwanted spacing at top of all pages by removing sticky navigation behavior, eliminating py-6 padding from App layout wrappers, and applying negative margins (-mt-2) to page containers. This creates clean layout with content starting immediately after navigation bar.
