...
ALTER TABLE "property_controllers" ADD COLUMN "branch_name" text;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_property_ctrl_branch" ON "property_controllers" USING btree ("customer_id","controller_letter",COALESCE("branch_name", ''));