...
- [What production is actually running](deployed-commit-vs-main.md) — publishing lags merges; find the deployed commit before verifying or running anything "on production".
