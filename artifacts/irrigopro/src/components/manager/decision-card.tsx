...
export function DecisionCard({
  ...
  return (
    <button
      ...
      data-testid={testId}
      className={`text-left rounded-lg border-2 ${a.border} ${a.bg} p-4 min-h-[88px] transition-all outline-none ${a.ring} disabled:opacity-50 disabled:cursor-not-allowed`}
    >
